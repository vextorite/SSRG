...
NormA=round(sqrt(pow(val_1,2)+pow(val_2,2)+pow(val_3,2)),3)
NormB=round(sqrt(pow(val_4,2)+pow(val_5,2)+pow(val_6,2)),3)
OutputNormA="|A| = "+str('{0:.2f}'.format(float(NormA)))
print(OutputNormA)
OutputNormB="|B| = "+str('{0:.2f}'.format(float(NormB)))
print(OutputNormB)